  ...
  return (
    <div className="flex flex-col gap-2">
      <Link
        ...
        className="flex flex-col border border-borda bg-paper transition-colors hover:border-lacre md:flex-row"
      >
      ...
      {publicacao.link && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="meta self-start text-chumbo-lt hover:text-lacre"
        >
